  ...
  <div class="login-page">
    <div class="card">
      ...
      <div class="p-fluid">
        ...
        <input id="email" type="text" v-model="form.email" class="p-inputtext p-component"
          placeholder="you@example.com" />

        <label for="password">Password</label>
        <input id="password" type="password" v-model="form.password" class="p-inputtext p-component"
          placeholder="••••••••" />
